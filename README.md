...
<p>
  ...
  <a href="https://lattes.cnpq.br/6643525904004318">
    <img src="https://img.shields.io/badge/Lattes-0B5FA5?style=for-the-badge&logoColor=white" alt="Currículo Lattes"/>
  </a>
...
<details>
<summary><b>Click to read the full profile in English</b></summary>

<br>

### Raw data, useful answers.

I build the pipelines that sit between sequencing and the decision someone has to make.

📍 Ouro Preto, Brazil · UFOP · PPGBiotec

### Who I am

Computer Engineer from UFOP, now a master's student in Biotechnology and a researcher in immunoinformatics. I came to biology from engineering, and that crossing defines my work: I bring systems architecture, APIs, and databases to a field that often lacks them.

Epitope prediction, conservation screening, membrane topology, variant prioritization — and the engineering that makes all of it run again tomorrow with the same result. No hidden manual step. No result nobody can reproduce.

I have coordinated a research project as an undergraduate, deployed an RFID system in a hospital, presented a poster as lead author at a national symposium, and today I build an environmental traceability platform that runs offline in the middle of the forest.

### What I do

| | |
|---|---|
| **Immunoinformatics** | Epitope prediction and screening, cross-species conservation, and membrane topology for antigen design. |
| **Clinical genomics** | Whole-exome pipelines: variant calling and prioritization, functional annotation, and reproducible reporting. |
| **Data engineering** | Databases, APIs, and geospatial layers that turn spreadsheets and field photos into auditable records. |
| **Field systems** | Mobile applications with offline sync and RFID tracking, for places with no signal and no margin for error. |
| **Custom work** | If the problem does not fit any box above, it is probably the kind of thing that interests me. |

I do not work with a fixed stack. I adapt to what the problem requires.

### Projects

| Project | Period | |
|---|---|---|
| **[POA — Antigen Optimization Pipeline](https://github.com/ImAyron/POA_Project)** | 2026 — | In development |
| **[Gestmi — Hospital asset management via RFID](https://github.com/ImAyron/Gestmi_RFID)** | 2021 — 2025 | Completed |
| **[IX SNNB References](https://github.com/ImAyron/Referencias-IXNN-SNNB)** | 2026 | Poster |
| **[Pattern recognition](https://github.com/ImAyron/reconhecimento_padroes)** | 2026 | Academic |
| **[São Gonçalo do Rio Abaixo Tourism](https://github.com/ImAyron/processoseletivoif)** | 2026 | Completed |
| **[Compiler — Course project](https://github.com/ImAyron/TP_Compiladores_Final_2)** | — | Completed |

The integrated clinical exome pipeline for ASD and the automated variant prioritization work continue in private repositories.

### Where I am

**Bioinformatics Researcher** · LABIS · UFOP · *2025 — present*
Immunoinformatics under Dr. Breno Mello: epitope prediction and screening for vaccine antigen design.
`Python` `Biopython` `IEDB` `Linux`

**Software Engineer** · Limbo Florestal · *May 2026 — present*
Environmental traceability platform for a germplasm rescue and forest restoration program along the BR-116/MG corridor. It follows every individual plant from the field census through the nursery, transplanting, and monitoring — within the SINAFLOR, MMA 148/2022, CITES, and CNCFlora frameworks.
`React Native` `Expo` `WatermelonDB` `NestJS` `PostgreSQL` `PostGIS` `Python`

**Previously:** Freelance software developer (Apr 2019 — Nov 2024), five and a half years of full-stack web work, including Gestmi and the DOTLEAD CRM · Undergraduate research fellow, Fapemig (Oct 2021 — Oct 2024), hospital linen management via RFID · R&D intern, Hospital Margarida (2022 — 2024), Laravel platform for RFID tag management · Teacher and coordinator of the Technical Course in Informatics, E. E. Luiz Prisco de Braga (Jul 2023 — Jun 2024).

### Output

- **Poster** · *An Integrated and Low-Cost Bioinformatics Pipeline for Clinical Whole-Exome Analysis Applied to Autism Spectrum Disorder* — IX Northeast Bioinformatics Symposium, UFRN (2026) · lead author
- **Organization** · 1st Symposium on Autism Genetics of the Inconfidentes Region (2025)
- **Thesis** · *Computerization of linen control in a medium-sized philanthropic hospital* — Computer Engineering, ICEA/UFOP (2025)
- **Attendance** · XXVI Brazilian Symposium on Computing Applied to Health, SBCAS (2026) · The MedTech Conference, Toronto (2024)

### Education

**MSc in Biotechnology** — PPGBiotec/UFOP · *2025 — present*
Bioinformatics applied to genetics · Advisor: Dr. Breno Mello

**BSc in Computer Engineering** — ICEA/UFOP · *2019 — 2025*
Thesis on hospital computerization with RFID

### Languages

Portuguese — native · English — proficient · Spanish — proficient
...
**[ayronpaiva@outlook.com](mailto:ayronpaiva@outlook.com)** · **[Lattes](https://lattes.cnpq.br/6643525904004318)** · **[LinkedIn](https://www.linkedin.com/in/ayron-luigi-873317193/)**
